...
print(f"Classes       : Class 0, Class 1, Class 2 (3 wine types)")
print("\nFirst 10 Rows of Dataset:")
print("-" * 60)
print(df[['alcohol', 'malic_acid', 'ash', 'magnesium', 'wine_class']].head(10).to_string(index=False))
print("=" * 60)
...
Description:
  ...
  Here it predicts which type of wine (0, 1, or 2) based on
  its chemical properties like alcohol, ash, and magnesium.
""")
...
Description:
  ...
  of yes/no questions about the wine's chemical properties
  and follows a path to classify which type of wine it is.
...
Description:
  ...
  Class 1 wine, the new wine is classified as Class 1.
...
Description:
  ...
  classification by rounding its output to 0, 1, or 2.
  It finds the best linear relationship between the wine's
  chemical properties and its class. It is the simplest
...
Description:
  ...
  and assigns each wine sample to the nearest center.
